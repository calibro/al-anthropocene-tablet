app.controller('CreateCtrl', function($scope,$rootScope,$stateParams,apiService,mediaService,playlistService,$timeout,$window,$ionicHistory,$ionicScrollDelegate,$state,socket,Idle) {
  ...
  $scope.$on('$ionicView.afterEnter', function (){
    ...
    $scope.tab = 'themes';
    socket.emit('changeView',{view:"create",room:room});
  ...
  $scope.checkSelected = function(id) {
    ...
    $scope.$watchCollection('selEntities',function(newValue, oldValue){
        socket.emit('entities',{entities: _.pluck(newValue,'id'),room:room});
